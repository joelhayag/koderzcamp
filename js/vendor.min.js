          ...
          !1 !== V.uiBackCompat &&
            V.extend(V.effects, {
              ...
              setMode: function (t, e) {
                return (e =
                  "toggle" === e ? (t.is(":hidden") ? "show" : "hide") : e);
              },
        ...
        (y = V.effects),
              ...
              i.animate(g, {
                ...
                complete: function () {
                  ...
                  0 === g.opacity && i.css("opacity", f.opacity),
                    l ||
                      (i
                        .css("position", "static" === u ? "relative" : u)
                        .offset(t),
                      V.effects.saveStyle(i)),
                    e();
                },
          ...
          V.effects.define("slide", "show", function (t, e) {
            var i,
              ...
              h = "up" === r || "left" === r,
              c =
                t.distance || n["top" == l ? "outerHeight" : "outerWidth"](!0),
              u = {};
            V.effects.createPlaceholder(n),
              (i = n.cssClip()),
              (s = n.position()[l]),
        ...
        (V.ui.keyCode = {
          ...
          V.widget("ui.accordion", {
            ...
            _animate: function (t, i, e) {
              ...
              return (
                (n =
                  (n = "string" == typeof u ? u : n) || u.easing || c.easing),
                (o =
          ...
          V.widget("ui.menu", {
            ...
            _scrollIntoView: function (t) {
              ...
              this._hasScroll() &&
                ((i =
                  parseFloat(V.css(this.activeMenu[0], "borderTopWidth")) || 0),
        ...
        V.extend(V.ui, { datepicker: { version: "1.13.1" } }),
          V.extend(st.prototype, {
            ...
            _autoSize: function (t) {
              ...
              this._get(t, "autoSize") &&
                ...
                (a = this._get(t, "dateFormat")).match(/[DM]/) &&
                  ...
                  o.setDate(
                    e(
                      this._get(t, a.match(/DD/) ? "dayNames" : "dayNamesShort")
                    ) +
                      20 -
                      o.getDay()
                  )),
            ...
            formatDate: function (e, t, i) {
              ...
              var o,
                a =
                  (i ? i.dayNamesShort : null) || this._defaults.dayNamesShort,
          ...
          _mouseInit: function () {
            ...
            this.element
              ...
              .on("click." + this.widgetName, function (t) {
                if (
                  !0 === V.data(t.target, e.widgetName + ".preventClickEvent")
                )
                  return (
            ...
            resize: function (t) {
              ...
              r[0] !== document && /static/.test(r.css("position")) && (a = s),
                n.left < (e._helper ? s.left : 0) &&
                  ...
                  o &&
                    ((e.size.height = e.size.width / e.aspectRatio), (t = !1)),
                ...
                n.top < (e._helper ? s.top : 0) &&
                  ...
                  o &&
                    ((e.size.width = e.size.height * e.aspectRatio), (t = !1)),
                      ...
                      ((s =
                        ...
                        (this.options.greedy &&
                          ...
                          (i = this.element
                            ...
                            .filter(function () {
                              return (
                                V(this).droppable("instance").options.scope ===
                                e
                              );
                            })).length &&
        ...
        V.ui.droppable,
          ...
          V.widget("ui.slider", V.ui.mouse, {
            ...
            _values: function (t) {
              ...
              if (arguments.length)
                return (
                  (t = this.options.values[t]), (t = this._trimAlignValue(t))
                );
                      ...
                      ((e.height() &&
                        ...
                        e.height(
                          i.currentItem.innerHeight() -
                            ...
                            parseInt(
                              i.currentItem.css("paddingBottom") || 0,
                              10
                            )
                        ),
                      e.width() ||
                        e.width(
                          i.currentItem.innerWidth() -
                            parseInt(
                              i.currentItem.css("paddingLeft") || 0,
                              10
                            ) -
              ...
              var n =
                  "clippingParents" === e
                    ? (function (t) {
                        var e = Ae(te(t)),
                          i =
                            ["absolute", "fixed"].indexOf(Gt(t).position) >=
                              0 && Ft(t)
                              ? ie(t)
                              : t;
                        return Bt(i)
