...
function draw(e, t) {
  ...
  (a = pathDefs.checkmark),
    (n = animDefs.checkmark),
    i.push(
  ...
  for (var r = 0, s = i.length; r < s; ++r) {
    ...
    (l.style.strokeDasharray = c + " " + c),
      (l.style.strokeDashoffset = 0 === r ? Math.floor(c) - 1 : c),
      l.getBoundingClientRect(),
      (l.style.transition =
        l.style.WebkitTransition =
        l.style.MozTransition =
          "stroke-dashoffset " +
          n.speed +
          "s " +
          n.easing +
...
if (
  ...
  $(document).ready(function () {
    if ($("#znav-container").length) {
      ...
      ($this = $("#znav-container")),
        $(
          "#znav-container #navbarNavDropdown ul.navbar-nav .dropdown"
        ).each(function () {
          ($this = $(this)), $this.parent("li").addClass("has-dropdown");
        }),
        $(
          "#znav-container #navbarNavDropdown ul.navbar-nav .megamenu"
        ).each(function () {
          ($this = $(this)), $this.parent("li").addClass("has-megamenu");
        }),
        $(".has-dropdown > a, .has-megamenu > a").on(
          "click",
          function () {
            ($this = $(this).parent()),
              $this.each(function () {
        ...
        ($preIndex = a.index()),
          ...
          $(window).on("resize", function () {
            e(
              n,
              t,
              t.children(".nav-bar").children(".nav-bar-item.active")
            );
          });
      });
  }),
  ...
  $(document).ready(function () {
    $(".flexslider").length &&
      $(".flexslider").each(function () {
        var e = $(this);
        e.flexslider({ controlNav: e.data("controlnav") });
      });
  }),
  $(document).ready(function () {
    $(".owl-carousel").length &&
    ...
    Array.prototype.forEach.call(n, function (e) {
      ...
      e.addEventListener("change", function (e) {
        ...
        (n =
          ...
          n ? (t.querySelector("span").innerHTML = n) : (t.innerHTML = a);
      }),
      ...
      e.on("submit", function (t) {
        ...
        a.val("Sending..."),
          $.ajax({
            ...
            data: $(this).serialize(),
            success: function (t) {
              e.children(".zform-feedback").html(t),
                a.val(n),
                e.trigger("reset");
            },
          });
  ...
  $(document).ready(function () {
    $(".palette").length &&
      $(".palette [class*='background-']").each(function () {
        $(this).append(
          '<p class="text-uppercase fs--1 mb-0">' +
            (function (e) {
              return (
                (e = e.match(
